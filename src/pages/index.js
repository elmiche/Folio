...
{/*     
    <div class="conatiner bg-cover bg-origin-border rounded-lg p-4 bg-white bg-opacity-95 flex flex-row space-y-5"> 
      ...
      <div className="object-none pb-3/4">
        <StaticImage 
          ...
          <div className=" text-lg rounded-lg bg-origin-border p-4 bg-white bg-opacity-95 object-top flex flex-col">
